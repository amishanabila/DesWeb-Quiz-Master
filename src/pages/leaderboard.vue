  ...
  <div>
    ...
    >
      ...
      <div class="w-full md:w-1/2 mb-10 md:mb-0">
        <h1 class="text-4xl font-bold text-gray-800 mb-6">Leaderboard</h1>

        <div class="max-h-[300px] overflow-y-auto border rounded-lg p-4 bg-white shadow">
          <ul class="text-lg text-gray-700 space-y-2">
            <li
              v-for="(item, index) in leaderboard"
              :key="index"
              class="flex justify-between w-60"
            >
      ...
      <div class="flex justify-center md:justify-end w-full md:w-1/2 mb-10">
        <img src="@/assets/logo.png" alt="QuizMaster Logo" class="w-100 object-contain" />
      </div>
    </main>
...
// Ambil data leaderboard saat mount
onMounted(() => {
  leaderboard.value = JSON.parse(localStorage.getItem('leaderboard')) || []
})

// 🔹 Hapus leaderboard dengan konfirmasi popup
